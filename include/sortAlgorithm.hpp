...
void SortAlgorithms<T>::runAlgorithm(T* vector, char whichAlgorithm) {
  ...
  this->sortPerformanceObject.milissecs = restp.tv_nsec;

  switch(whichAlgorithm)
  {
    case 'a':
      this->sortPerformanceObject.sortName = "Bubble Sort";
      break;
    case 'i':
      this->sortPerformanceObject.sortName = "Insertion Sort";
      break;
    case 's':
      this->sortPerformanceObject.sortName = "Selection Sort";
      break;
    case 'm':
      this->sortPerformanceObject.sortName = "Merge Sort";
      break;
    case 'q':
      this->sortPerformanceObject.sortName = "Quick Sort";
      break;
    case 'j':
      this->sortPerformanceObject.sortName = "Quick Sort Median of Three";
      break;
    case 'o':
      this->sortPerformanceObject.sortName = "Quick Sort Median of Three with Insertion Sort";
      break;
    case 'h':
      this->sortPerformanceObject.sortName = "Shell Sort";
      break;
    case 'c':
      this->sortPerformanceObject.sortName = "Counting Sort";
      break;
    case 'u':
      this->sortPerformanceObject.sortName = "Bucket Sort";
      break;
    case 'r':
      this->sortPerformanceObject.sortName = "Radix Sort";
      break;
  }
